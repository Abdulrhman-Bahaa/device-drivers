...
Std_ReturnType ecual_us_sensor_invoke_on_range(const us_sensor_config_t* us_sensor, const uint16_t range_start, const uint16_t range_end, void (*function_to_invoke)(void));
